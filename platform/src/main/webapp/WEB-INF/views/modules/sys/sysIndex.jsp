	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<div class="brand"><span id="productName">儿童智能托管平台</span></div>
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            ...
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} 儿童智能托管平台 - Powered By <a href="http://jeesite.com" target="_blank">zhuangyandong</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
