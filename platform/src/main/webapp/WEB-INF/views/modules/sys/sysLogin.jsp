...
<body>
	...
	<div class="footer">
		Copyright &copy; 2018} 欢迎使用儿童智能托管平台
		<%-- <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="http://jeesite.com" target="_blank">JeeSite</a> ${fns:getConfig('version')}  --%>
	</div>
