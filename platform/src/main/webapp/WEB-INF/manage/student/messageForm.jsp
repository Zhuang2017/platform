...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/student/message/">留言信息列表</a></li>
		<li class="active"><a href="${ctx}/student/message/form?id=${message.id}">留言信息<shiro:hasPermission name="student:message:edit">${not empty message.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="student:message:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="message" action="${ctx}/student/message/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="controls">
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								...
								<th>回复内容</th>
								<th>回复类型</th>
								<shiro:hasPermission name="student:message:edit"><th width="10">&nbsp;</th></shiro:hasPermission>
							</tr>
						</thead>
						<tbody id="mesReplyList">
						</tbody>
						<shiro:hasPermission name="student:message:edit"><tfoot>
					...
					<script type="text/template" id="mesReplyTpl">//<!--
						<tr id="mesReplyList{{idx}}">
							...
							<shiro:hasPermission name="student:message:edit"><td class="text-center" width="10">
		...
		<div class="form-actions">
			<shiro:hasPermission name="student:message:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
