...
<body>
	...
	<form:form id="inputForm" modelAttribute="behaviour" action="${ctx}/student/behaviour/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="student" name="student" value="${behaviour.student}" labelName="" labelValue="${behaviour.}"
					title="用户" url="/sys/office/treeData?type=3" cssClass="" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">内容（如学生期间做的值得表扬的事）：</label>
			<div class="controls">
				<form:textarea path="content" htmlEscape="false" rows="4" maxlength="512" class="input-xxlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">内容（含标签）：</label>
			<div class="controls">
				<form:input path="contentHtml" htmlEscape="false" maxlength="512" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">表现的时间：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="teacher" name="teacher" value="${behaviour.teacher}" labelName="" labelValue="${behaviour.}"
					title="用户" url="/sys/office/treeData?type=3" cssClass="" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="control-group">
